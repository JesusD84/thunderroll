...
async def send_password_reset_email(to_email: str, reset_token: str) -> None:
    ...
    html_body = f"""
    <p>You requested a password reset for your Thunderoll account.</p>
    ...
    plain_body = (
        f"You requested a password reset for your Thunderoll account.\n\n"
    ...
    message = MessageSchema(
        subject="Thunderoll — Password Reset Request",
        recipients=[to_email],
        body=html_body,
